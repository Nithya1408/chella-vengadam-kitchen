    ...
    <div className="about-page">
      ...
      <section className="about-story">
        <div className="container story-grid">
          ...
          <div className="story-right">
            <p>
              In 1962, in a small Vellore home, our grandmother Thirupuram began cooking
              for the families on her street. Word spread quickly about her Chettinad mutton
          ...
          <div className="timeline">
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <p>Grandmother Thirupuram cooks her first Chettinad mutton kuzhambu for the neighbourhood. People come back. And bring others.</p>
              </div>
            </div>
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <p>She writes down every recipe in a single notebook. Some pages still smell like the cardamom from her shelf.</p>
              </div>
            </div>
            <div className="timeline-item">
        ...
        <div className="container visit-grid">
          ...
          <div className="visit-visual">
            <div className="visit-card vc-1">
              <p className="vc-num">1962</p>
              <p>Family-run since</p>
            </div>
            <div className="visit-card vc-2">
              <p className="vc-num">3</p>
              <p>Generations of cooks</p>
            </div>
            <div className="visit-card vc-3">
              <p className="vc-num">200+</p>
              <p>Heritage recipes</p>
            </div>
            <div className="visit-card vc-4">
              <p className="vc-num">15</p>
              <p>Tables, every guest known</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="about-quote">
        <div className="container">
          ...
          <p className="quote-attribution">Grandmother Thirupuram · 1962</p>
        </div>
      </section>
    </div>
  );
